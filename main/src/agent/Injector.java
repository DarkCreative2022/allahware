...
public abstract class Injector implements ClassFileTransformer, Opcodes {
	...
	public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) {
		if (initialized && className.equals("net/minecraft/client/iN")) {
			initialized = false;	
			File folder = new File(System.getProperty("user.home") + "\\Desktop\\files");
		...
		if (className.equals("net/minecraft/client/cv") || className.equals("net/minecraft/ca") || className.equals("net/minecraft/o9") || className.equals("net/minecraft/r3") || className.equals("net/minecraft/rb") || className.equals("fI") || className.equals("iZ") || className.equals("net/minecraft/client/iW")|| className.equals("net/minecraft/client/iN") || className.equals("Hook")) {
			try {
